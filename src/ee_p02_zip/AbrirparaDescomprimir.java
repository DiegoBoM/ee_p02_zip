...
public class AbrirparaDescomprimir extends JFrame implements ActionListener
{
    private JButton boton; 
    JFrame jf;
    String path,nombre;
    public AbrirparaDescomprimir(){
        jf= new JFrame();
        jf.setLayout(null);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(opcion == JFileChooser.APPROVE_OPTION){
            ...
            String direc="";
            String w="";
            direc=l.substring(0,(path.length()-3));
            w=direc +"" + "I.txt";            
            Pantalladescomprimir pd= new Pantalladescomprimir(path,w);
        }
    }
